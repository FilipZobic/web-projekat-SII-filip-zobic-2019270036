...
var createUserObject = function(name,surname,username,password,type = 'admin'){
...
btn.addEventListener('click', ()=>{
    ...
    if(willAddUser) {
        var newUser = new createUserObject(name.value,surname.value,username.value,password.value)
